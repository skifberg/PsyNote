...
### [Дата] - Настройка окружения
- Принято решение использовать Python + FastAPI
- Создана структура backend/ с api/, models/, services/
- Решено сделать веб-версию вместо мобильного приложения

### [Дата] - Архитектурные решения
- ...